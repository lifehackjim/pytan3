...
downloaded_on = "2019-02-19 22:17:34.469909"

from_version = "7.3.314.3641"
    ...
    <xsd:schema xmlns="urn:TaniumSOAP" targetNamespace="urn:TaniumSOAP">
      ...
      <xsd:complexType name="sensor_subcolumn">
        <xsd:all>
          ...
          <xsd:element name="exclude_from_parse_flag" type="xsd:int" minOccurs="0"/> <!-- Historical, unused -->
        </xsd:all>
      </xsd:complexType>
      ...
      <xsd:complexType name="user_group">
          <xsd:all>
              ...
              <xsd:element name="metadata" type="metadata_list" minOccurs="0"></xsd:element>
          </xsd:all>
      </xsd:complexType>
      ...
      <xsd:complexType name="ldap_sync_connector">
          <xsd:all>
             ...
             <xsd:element name="sync_individual_members_flag" type="xsd:int" minOccurs="0" maxOccurs="1"></xsd:element>
          </xsd:all>
      </xsd:complexType>
