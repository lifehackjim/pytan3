#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Utility for generating API objects files for PyTan.
...
For each directory in this scripts path that has a file console.wsdl:
    ...
    for each filename in [soap.py, rest.py]:
...
.. automodule:: pytan3.api_objects.{type}_{major}_{minor}_{protocol}_{build}
    :members:
    :undoc-members:
    :show-inheritance:
    :private-members:
    ...
    for path in paths:
        ...
        for obj_file in obj_files:
            ...
            py_contents = black.format_file_contents(
                src_contents=py_contents, line_length=88, fast=False
            )
