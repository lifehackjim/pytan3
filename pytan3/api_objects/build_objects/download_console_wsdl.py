...
def main(url, output_dir, pytan3, overwrite=False):
    ...
    client.certify()
    version = pytan3.api_clients.get_version(client)
    wsdl = pytan3.api_clients.get_wsdl(client)
    ...
    url_path = pytan3.api_clients.WSDL_PATH
    ...
    m = (
        "Done with version {version!r}, "
        "you need to manually populate 'rest.py' and/or 'soap.py'"
    )
...
if __name__ == "__main__":
    ...
    sys.path.insert(0, format(args.pytan_path))
    import pytan3
