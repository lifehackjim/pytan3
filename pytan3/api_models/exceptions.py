...
class ModuleError(exceptions.PyTanError):
    """Parent of all exceptions for :mod:`pytan3.api_models`.
...
class ModuleWarning(exceptions.PyTanWarning):
    """Parent of all warnings for :mod:`pytan3.api_models`.
...
class AttrUndefinedWarning(ModuleWarning):
    ...
    Thrown from:
      * :func:`pytan3.api_models.ApiModel.api_coerce_value`.
    ...
    def __init__(self, obj, attr, value):
        ...
        """
        self.obj = obj
        """:obj:`pytan3.api_models.ApiModel`: Object that warning was thrown from."""
        self.attr = attr
...
class ListTypeError(ModuleError):
    ...
    Thrown from:
      * :func:`pytan3.api_models.ApiList.api_coerce_items`.
    ...
    def __init__(self, obj, attr, value, op):
        ...
        Args:
            obj (:obj:`pytan3.api_models.ApiList`):
                Object that exception was thrown from.
            attr (:obj:`str`):
                Attribute that had a type mismatch.
            value (:obj:`object`):
...
class ListItemTypeError(ModuleError):
    ...
    Thrown from:
      * :func:`pytan3.api_models.ApiList.api_coerce_item`.
...
class GetSingleItemError(ModuleError):
    ...
    Thrown from:
      * :func:`pytan3.api_models.ApiList.get_item_by_attr`.
      * :func:`pytan3.api_models.ApiList.pop_item_by_attr`.
