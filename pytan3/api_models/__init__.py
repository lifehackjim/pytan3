...
class ApiModel(object):
    ...
    def api_coerce_value(self, attr, value):
        ...
        Raises:
            :exc:`pytan3.api_models.exceptions.AttrTypeError`:
                If value is not the expected type after all of this magic.
            :exc:`pytan3.api_models.exceptions.AttrUndefinedError`:
                If value type is not :data:`simple_types` and attr is not in
                :attr:`api_attrs`.
            :exc:`pytan3.api_models.exceptions.AttrUndefinedWarning`:
...
class ApiList(ApiModel):
    ...
    def api_coerce_items(self, attr, value, op):
        ...
        Raises:
            :exc:`pytan3.api_models.exceptions.ListTypeError`:
    ...
    def api_coerce_item(self, item, items, attr, op):
        ...
        Raises:
            :exc:`pytan3.api_models.exceptions.ListItemTypeError`:
    ...
    def get_item_by_attr(self, value, attr="name", regex_value=False):
        ...
        Raises:
            :exc:`pytan3.api_models.exceptions.GetSingleItemError`:
